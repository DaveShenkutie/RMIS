            ...
            <div class="col-lg-8 col-md-12 col-xs-12 slider">
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    <div class="heading-properties">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="p-r">
                                    <h3>Birr<?php echo number_format($price, 2); ?></h3>
                    ...
                    <div class="carousel-inner">
                        ...
                        $query = mysqli_query($con, "select * from image where pid='$id'");
                        ...
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="assets/img/uploads/<?php echo $img[0]; ?>" class="img-fluid" alt="property-1">
                        </div>
                        ...
                        <div class="item carousel-item" data-slide-number="4">
                            <img src="assets/img/uploads/<?php
                                                            ...
                                                            ?>" class="img-fluid" alt="property-4">
                        </div>
                        ...
                        <div class="item carousel-item" data-slide-number="5">
                            <img src="assets/img/uploads/<?php
                                                            ...
                                                            ?>" class="img-fluid" alt="property-5">
                        </div>
                    ...
                    <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                        <li class="list-inline-item active">
                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/uploads/<?php echo $img[0]; ?>" class="img-fluid" alt="property-4">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/uploads/<?php
                                                                ...
                                                                ?>" class="img-fluid" alt="property-6">
                            </a>
                        </li>
                        <li class="list-inline-item">
                        ...
                        <li class="list-inline-item">
                            <a id="carousel-selector-4" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/uploads/<?php
                                                                ...
                                                                ?>" class="img-fluid" alt="property-8">
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="amenities-box mb-60">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <ul>
                                            <li>
                                                <strong>Property Lot Size:</strong> <?php echo $land_area; ?>
                                            </li>
                                            <li>
                        ...
                        <div class="tab-pane fade " id="6" role="tabpanel" aria-labelledby="6-tab">
                            <div class="related-properties">
                                ...
                                <div class="row">
                                    ...
                                    $u_name = ucfirst($admin['registeredBy']);
                                            ...
                                            <div class="property-box">
                                                <div class="property-thumbnail">
                                                    <a href="properties-details.php" class="property-img">
                                                        ...
                                                        <img src="assets/img/uploads<?php echo $img; ?>" alt="property-1" class="img-fluid">
                                                    </a>
                                                ...
                                                <div class="detail">
                                                    ...
                                                    <ul class="facilities-list clearfix">
                                                        ...
                                                        <li>
                                                            <i class="flaticon-square-layouting-with-black-square-in-east-area"></i><?php echo $res['price']; ?> Sq Ft
                                                        </li>
                                                        <li>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <ul>
                                ...
                                <li><span><i class="flaticon-bath"></i> <?php echo $bedroom; ?> Bathroom</span></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <ul>
                                <li><span><i class="flaticon-car-repair"></i> 1 Garage</span></li>
                                <li><span><i class="flaticon-balcony-and-door"></i><?php echo $kichan; ?> Balcony</span></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <ul>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-content">
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <p>Gift Guarantees 24/7 power supply to enhance your life quality in an all-round way..</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="comment">
                                ...
                                <div class="comment-content">
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <p>The Project is equipped with a large number of life and leisure facilities such as Supermarkets, Cinema, Commercial Street, fitness amenities, Children's amusement park, etc. which provide One-Stop noble life experience.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sidebar mbl">
                    ...
                    <div class="helping-center widget clearfix">
                        <div class="media">
                            ...
                            <div class="media-body  align-self-center">
                                <h5 class="mt-0">Set Appointment</h5>

                                <h4><a href="setAppointment.php">Set appintment to see the place</a></h4>
